...
(()=>{
  ...
  const loadEnhancements=()=>{
    ...
    loadScript('transport-choice-ui-fix.js?v=20260823-2','data-horizon-transport-choice-fix');
    ...
    loadScript('prototype-transport-policy.js?v=20260823-3','data-horizon-prototype-transport-policy');
    ...
    loadScript('transport-cleanup-v1.js?v=20260823-2','data-horizon-transport-cleanup');
  };
