...
(()=>{
  ...
  const loadEnhancements=()=>{
    ...
    loadScript('flight-duration-fix.js?v=20260822-1','data-horizon-flight-duration-fix');
    ...
    loadScript('travelpayouts-lazy.js?v=20260822-2','data-horizon-flights-lazy');
  };
